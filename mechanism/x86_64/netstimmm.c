...
#define _tqitem &(_ppvar[2]._pvoid)
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NetStimm /home/jg/ModelosNeuron/ProgramsNeuronCA1_JG/CleanVersion_CA1_JG_15Mar09/mechanism/x86_64/netstimmm.mod\n");
...
{
 {
   ...
   if ( start >= 0.0  && number > 0.0 ) {
     ...
     artcell_net_send ( _tqitem, (double*)0, _ppvar[1]._pvoid, event + 2.0 * burstP , 3.0 ) ;
     artcell_net_send ( _tqitem, (double*)0, _ppvar[1]._pvoid, event + 3.0 * burstP , 3.0 ) ;
     artcell_net_send ( _tqitem, (double*)0, _ppvar[1]._pvoid, event + 4.0 * burstP , 3.0 ) ;
     artcell_net_send ( _tqitem, (double*)0, _ppvar[1]._pvoid, event + 5.0 * burstP , 3.0 ) ;
     artcell_net_send ( _tqitem, (double*)0, _ppvar[1]._pvoid, event + 6.0 * burstP , 3.0 ) ;
     artcell_net_send ( _tqitem, (double*)0, _ppvar[1]._pvoid, event + 7.0 * burstP , 3.0 ) ;
     artcell_net_send ( _tqitem, (double*)0, _ppvar[1]._pvoid, event + 8.0 * burstP , 3.0 ) ;
     artcell_net_send ( _tqitem, (double*)0, _ppvar[1]._pvoid, event + 9.0 * burstP , 3.0 ) ;
     }
   }
