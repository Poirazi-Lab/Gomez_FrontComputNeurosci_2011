...
#define _tqitem &(_ppvar[2]._pvoid)
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 GABAb /home/jg/ModelosNeuron/ProgramsNeuronCA1_JG/CleanVersion_CA1_JG_15Mar09/mechanism/x86_64/gabab.mod\n");
 ...
 v=_v;
{
 ...
 error =  release();
 if(error){fprintf(stderr,"at line 110 in file gabab.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
