	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 cad /home/jg/ModelosNeuron/ProgramsNeuronCA1_JG/CleanVersion_CA1_JG_15Mar09/mechanism/x86_64/cad.mod\n");
 ...
 v=_v;
{
 ...
 error =  state();
 if(error){fprintf(stderr,"at line 75 in file cad.mod:\n:	SOLVE state METHOD euler\n"); nrn_complain(_p); abort_run(error);}
